...
namespace ImGui
{
    ...
    IMGUI_API bool          Selectable(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0), bool alignCenter = true, bool renderBullet = false, ImVec4 bulletCol = ImVec4(0, 0, 0, 0));
    ...
    IMGUI_API bool          BeginMainMenuBar( float x = 0.f, float y = 0.f );                                                // create and append to a full screen menu-bar.
...
enum ImGuiCol_
{
    ...
    ImGuiCol_Border,
    ImGuiCol_BorderWindow,          // color of border for our ImGui windows
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText( const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float m_flFontSize = 0.f );
    IMGUI_API void  AddTextFont( const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end, const ImFont* m_pFont, float m_flFontSize = 0.f );
