...
void ImDrawList::AddText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end, float m_flFontSize)
{
    AddText( NULL, m_flFontSize, pos, col, text_begin, text_end);
}

void ImDrawList::AddTextFont( const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end, const ImFont* m_pFont, float m_flFontSize )
{
    AddText( m_pFont, m_flFontSize, pos, col, text_begin, text_end );
}
