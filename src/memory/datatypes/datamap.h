...
{
public:
	EFieldTypes			m_iFieldType;						//0x0000
	const char*			m_szFieldName;					//0x0004
	int					m_iFieldOffset[ TD_OFFSET_COUNT ];	//0x0008
	unsigned short		m_uFieldSize;						//0x0010
	short				m_fFlags;							//0x0012
	std::byte			pad0[ 0xC ];						//0x0014
	DataMap_t*			m_pTypeDescription;				//0x0020
