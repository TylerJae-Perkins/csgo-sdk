...
public:
	void* pVTable;                  // 0x0000
	const char* m_szConsoleName;		// 0x0004
	std::byte pad0[ 12 ];             // 0x0008
	...
	const char* m_szWorldModel;		// 0x002C
	const char* m_szViewModel;		// 0x0030
	const char* m_szDroppedModel;		// 0x0034
	std::byte pad1[ 0x50 ];			// 0x0038
	const char* m_szHudName;			// 0x0088
	const char* m_szWeaponName;		// 0x008C
	...
	float m_flSpread[ 2 ];				// 0x0140
	float m_flInaccuracyCrouch[ 2 ];	// 0x0148
	float m_flInaccuracyStand[ 2 ];		// 0x0150
	std::byte pad14[ 0x8 ];			// 0x0158
	float m_flInaccuracyJump[ 2 ];		// 0x0160
	float m_flInaccuracyLand[ 2 ];		// 0x0168
	float m_flInaccuracyLadder[ 2 ];	// 0x0170
	float m_flInaccuracyFire[ 2 ];		// 0x0178
	float m_flInaccuracyMove[ 2 ];		// 0x0180
	float m_flInaccuracyReload;		// 0x0188
	int m_iRecoilSeed;				// 0x018C
	float m_flRecoilAngle[ 2 ];			// 0x0190
	float m_flRecoilAngleVariance[ 2 ];	// 0x0198
	float m_flRecoilMagnitude[ 2 ];		// 0x01A0
	float m_flRecoilMagnitudeVariance[ 2 ]; // 0x01A8
	int m_iSpreadSeed;				// 0x01B0
